		...
		<div class="vicp-wrap">
			...
			<div class="vicp-step1" v-show="step == 1">
				<div class="vicp-drop-area" @dragleave="preventDefault" @dragover="preventDefault" @dragenter="preventDefault" @click="handleClick" @drop="handleChange">
					...
					<input type="file" v-show="false" v-if="step == 1" @change="handleChange" ref="fileinput" accept="image/*">
				</div>
...
import mimes from '@/helpers/mimes.js';
import data2blob from '@/helpers/data2blob.js';
import effectRipple from '@/helpers/effectRipple.js';
