<template>
	<div class="vennly-video">
		<div class="__cov-video-container" @mouseenter="mouseEnterVideo" @mouseleave="mouseLeaveVideo">
			<video :class="{ 'hide-cursor': !state.contrlShow }" class="__cov-video" preload="none" @click="onClickVideo">
				<source v-for="(source, index) in sources" :src="source.src" type="video/mp4" :key="index" />
			</video>

			<div class="__cov-video-first-screen"
				:style="{
					'background-image': `url(${options.poster})`,
				}"
				v-show="state.firstShow"
				@click="firstPlay"
			>
				<svg width="100px" height="100px" viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
					<g id="Screens" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
						<g id="Home" transform="translate(-670.000000, -417.000000)">
							<g id="Group-5" transform="translate(384.000000, 278.000000)">
								<g id="Group-3">
									<g id="Play" transform="translate(286.000000, 139.000000)">
										<circle id="Stroke" stroke="#FFFFFF" stroke-width="3" cx="50" cy="50" r="48.5"></circle>
										<path d="M70.6728111,51.615 L39.5668203,66.49 C38.7926229,66.8300017 38.294932,67 38.0737327,67 C37.5760344,67 37.105993,66.8441682 36.6635945,66.5325 C36.2211959,66.2208318 36,65.8100025 36,65.3 L36,34.7 C36,34.1899974 36.2211959,33.7791682 36.6635945,33.4675 C37.105993,33.1558318 37.5760344,33 38.0737327,33 C38.294932,33 38.7926229,33.1699983 39.5668203,33.51 L70.6728111,48.385 C71.5576081,48.8383356 72,49.3766635 72,50 C72,50.6233364 71.5576081,51.1616644 70.6728111,51.615 Z" id="Icon" fill="#FFFFFF"></path>
									</g>
								</g>
							</g>
						</g>
...
<script>
	...
	export default {
		...
		mounted() {
			...
			this.$root.$on('tutorialStepChange', () => {
				this.$video.pause();
